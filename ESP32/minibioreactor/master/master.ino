...
void setup() {
  ...
  float ref_resistance = 10000;

  for (int i=0; i<N_ADC; i+=2){
    analogs[i].set_temperature_cal(thermistor[0], thermistor[1], thermistor[2]);
    analogs[i].set_temperature_resistor(ref_resistance);
  }
  // ------------ Modify Configuration -------------- //
}
